...
#html_scrape.css(".student-card") -
#name, location, profile_url


#student.css("a .student-name").text   - Name
#student.css("a .student-location").text - Location
#student.css("a").attribute("href").value - URL
# --------------------------
# html_scrape.css(".vitals-text-container .profile-quote").text - Profile quote
# html_scrape.css(".bio-content .description-holder p").text - Bio
# html_scrape.css(".social-icon-container a") - Socials array
